...
class Frame(tk.Frame):
    ...
    def campos_pelicula(self):
        ...
        self.boton_nuevo.config(width=20,font=("Arial",12,"bold"),fg="#DAD5D6",bg="#4aa037",cursor="hand2",activebackground="#5ea14f",activeforeground="white")
        self.boton_nuevo.grid(row=3,column= 0,padx=10,pady=10)
        
        
        self.boton_guardar = tk.Button(self,text="Guardar",command=self.guardar_datos)
        self.boton_guardar.config(width=20,font=("Arial",12,"bold"),fg="#DAD5D6",bg="#1658a2",cursor="hand2",activebackground="#3586df",activeforeground="white")
        self.boton_guardar.grid(row=3,column= 1,padx=10,pady=10)
        
        self.boton_cancelar = tk.Button(self,text="Cancelar",command=self.desabilitar_campos)
        self.boton_cancelar.config(width=20,font=("Arial",12,"bold"),fg="#DAD5D6",bg="#bd152e",cursor="hand2",activebackground="#e15370",activeforeground="white")
    ...
    def tabla_peliculas(self):
        ...
        #scrollbar para tabla si exede los 10 elementos
        ...
        self.boton_editar.config(width=20,font=("Arial",12,"bold"),fg="#DAD5D6",bg="#4aa037",cursor="hand2",activebackground="#5ea14f",activeforeground="white")
        self.boton_editar.grid(row=5,column= 0,padx=10,pady=10)
        
        
       
        self.boton_eliminar = tk.Button(self,text="Eliminar",command=self.eliminar_datos)
        self.boton_eliminar.config(width=20,font=("Arial",12,"bold"),fg="#DAD5D6",bg="#bd152e",cursor="hand2",activebackground="#e15370",activeforeground="white")

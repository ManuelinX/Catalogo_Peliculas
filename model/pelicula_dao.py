...
from tkinter import messagebox #para lanzar una ventana emergente
def crear_tabla():
    conexion = ConexionDB()
...
def borrar_tabla():
    ...
    try:
        ...
        mensaje = "La tabla de la base de adtos se borro con éxito"
        messagebox.showinfo(titulo,mensaje)
    except:
        titulo = "Borrar Registro"
...
def listar():
    ...
    try:
        conexion.cursor.execute(sql)
        lista_peliculas = conexion.cursor.fetchall() #recuperar toda la informacion
        conexion.cerrar()
    except:
...
def editar(pelicula,id_pelicula):
    ...
    sql = f"""UPDATE peliculas
            ...
            """
    #como id_pelicula es entero no va en comillas
    #pero como los demas son string, esos si
